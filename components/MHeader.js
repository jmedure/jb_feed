...
export default function MHeader(props) {
    ...
    return (
        <div className="py-4 md:py-5  w-full bg-white/80 backdrop-blur-sm z-40 sticky top-0 mt-0 border-b border-neutral-200 border-solid">
              <div className="w-full container-blog flex justify-between items-center mt-0">
                <Link href="/meditations" passHref>
                  <h1 className="text-2xl md:text-3xl flex font-fruit cursor-pointer hover:italic hover:tracking-tight tracking-tighter">Meditations of a Rockstar</h1>
                </Link>
