...
export default function SongCard( props ) {
    ...
    return(
        <Link href={`/songs/${slug}`} key={index} passHref>
            <div className='items-center py-4 w-full flex space-x-4 align-top cursor-pointer tracking-normal hover:bg-neutral-100 '>
                <div className="relative h-full w-16 border-solid border border-black aspect-square">
                    <Image 
                        src={src}
                        alt={alt}
                        layout="fill"
