...
export default function MainNav() {
  ...
  return (
    <div className="bg-white/90 pb-2 backdrop-blur-sm sticky top-[4.254rem] z-40 align-items-center text-center">
      <div className="py-2 flex w-full container space-x-4 items-center text-base">
        ...
        <ul className="flex justify-between space-x-2">
          <li className="">
            <Link href="/" className="">
              <a
                className={`hover:bg-black hover:border-black hover:text-white border-neutral-400 text-neutral-400 px-3 py-1 border border-solid rounded-full no-underline ${
                  router.pathname == '/'
                    ? 'border-solid border border-x-black border-y-black text-white bg-black drop-shadow-xl'
                    : ''
                }`}
              >
                All
