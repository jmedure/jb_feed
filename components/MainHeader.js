        ...
        >
          {props.buttons ? (
            ...
            <div
              className={
                (completion > 2
                  ? 'flex transition-all items-center  mx-auto bg-white border-black/5 border rounded-full drop-shadow-xl'
                  : 'flex transition-all items-center  mx-auto bg-white border border-black/0 rounded-full ') +
                ''
              }
            >
              <Logo />
