...
isPublished: 'true'
tile: '/design/1.png'
productionLink: 'https://createwcare.com'
productionLabel: 'live site'
repoLink: 'https://github.com/jmedure/cwc'
---

<div className="relative w-full not-prose pt-24 rounded-2xl border bg-gray-400 overflow-clip aspect-square sm:aspect-video">

    <Image
      src="/design/cwcbig.gif"
      alt="Image"
      placeholder="blur"
