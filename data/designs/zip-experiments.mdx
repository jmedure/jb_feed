...
<div className="not-prose text-base mx-auto max-w-[600px] w-full flex-col font-jbd  space-y-3 pt-4 ">
  <p className="capitalize font-bold">impact</p>
  <ImpactCard copy="+10% in-store new-user activation"/>
  <ImpactCard symbol="❖" copy="Developed a new, widely adopted onboarding pattern"/>
</div>
...
<Video
  ...
  caption="New User Checklist Prototype - for demonstration only"
/>
...
<CaseStudyMeta
  role="Product Design Lead - represented design in x-functional meetings, wrote and ran user tests, presented designs and earned stakeholder buy-in, ideated and defined product vision, refined and delivered designs through Engineering and QA."

  status="Rollout ~1500 users"
...
<div className="not-prose text-base mx-auto max-w-[600px] w-full  flex-col font-jbd  space-y-3 pt-4 ">
  ...
  <ImpactCard symbol="$" copy="Enabled a new spending vertical"/>
  <ImpactCard symbol="❖" copy="Developed several new, widely adopted payment patterns"/>
  <ImpactCard symbol="♖" copy="Represented design on a high visibility, high impact project"/>
...
<Video
  ...
  caption="Pay in 8 Shopping Flow Prototype - indicative of production"
/>
...
<div className="not-prose text-base mx-auto max-w-[600px]  w-full flex-col font-jbd  space-y-3 pt-4 ">
  <p className="capitalize font-bold">impact</p>
  <ImpactCard copy="+8% new-user activation"/>
</div>
