...
<div className="not-prose text-base mx-auto max-w-[600px] w-full flex-col font-jbd  space-y-3 pt-4 ">
  ...
  <ImpactCard copy="+10% In-store Shopping Activation"/>
</div>
...
<div className="not-prose text-base mx-auto max-w-[600px] w-full flex-col font-jbd  space-y-3 pt-4 ">
  <p className="capitalize font-bold">impact</p>
  <ImpactCard symbol="＄" copy="Enabled a completely new spending vertical"/>
  <ImpactCard symbol="❖" copy="Developed new payment patterns that were widely adopted"/>
