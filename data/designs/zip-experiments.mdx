...
Zip is a leading international buy-now, pay-later (BNPL) based out of Australia. Following the 2020 aquisition of Quadpay, Zip embarked on it's US journey. Zip's US product helps users split any purchase into 4 and [now 8](#pay-in-8) installments.
...
<div className="">
  ...
  >
    <div className="p-8 bg-neutral-100 dark:bg-neutral-800 border dark:border-white/10 space-y-2 rounded-xl not-prose  w-auto flex-1 flex-col flex">
      ...
      <span className="text-black/50 dark:text-white/50 text-sm pt-2">- Real Zip User</span>
    </div>
    <div className="p-8 bg-neutral-100 dark:bg-neutral-800 border dark:border-white/10 space-y-2 rounded-xl not-prose w-auto flex-1 flex-col flex">
      <span className="font-bold text-3xl italic">"</span>
      <span>
...
<div className="not-prose text-base mx-auto max-w-[600px] w-full flex-col font-jbd  space-y-3 pt-4 ">
  <p className="capitalize text-black/50 dark:text-white/50">impact</p>
...
<Video
  src="ba-categories.mp4"
  caption="Categories module before vs after"
/>
