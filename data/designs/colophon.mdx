...
This site uses [Next.js](https://nextjs.org), [Tailwind CSS](https://tailwindcss.com), and is written in [React](https://react.dev). I host on [Vercel](https://vercel.com) and use privacy first analytics provider, [Simple Analytics](https://simpleanalytics.com). Content is managed locally using a couple JSON files and many MDX files. It’s easy for me to write content in VS Code, and push changes to main. For the most part, animations are built leveraging [Framer Motion](https://www.framer.com/motion/).
...
Other than the "blog" parts of my site - where I’m regularly writing and spending entirely too much time rewriting css- the footer contains many regularly updated indexes. These indexes break down into detail pages that signal turn-around points for the user. Some cool indexes include, [every song I’ve ever released](/discography), [past versions of the website](/archive) and [valuable book recommendations](/library). These pages are a lot of fun to make and hopefully fun for you to look through.
...
- [Eike Drescher](https://www.eikedrescher.com/)
- [Marco Cornacchia](https://www.marco.fyi/)
- [Paco Coursey](https://paco.me/)
- [Rauno Freiberg](https://rauno.me/)
- [Rikitesh Nighot](https://nighot.com/)
- [Brian Lovin](https://brianlovin.com/)
- [Joseph Zhang](https://www.josephz.me/)
- [Ethan](https://area.cx)
- [Sebastian](https://www.carlhauser.com/)

Thank you for your work!

## Next

Making this site has made me more comfortable being all the things I am under one umbrella. Social media has made me feel like I'm _only_ a musician, but in the real world I am many things. Jacobs.blue is not only a good representation of this but helped me own it. I used to keep two websites, one for my design work, one for music. Now I'm comfortable with them in the same space. Like myself, jacobs.blue is a constant work in progress. Expect jacobs.blue to evolve and change shape as much as I do.
