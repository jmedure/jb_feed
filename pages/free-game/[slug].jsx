...
import { getSlug, getArticleFromSlug } from '../../src/utils/mdx_fg';
      ...
      <div className="container-blog prose-lg proseprose:neutral prose-headings:tracking-tighter prose-headings:font-serif prose-headings:font-medium py-20">
        <div className="not-prose flex-block font-sans border-b border-solid py-4 border-neutral-300">
          <div className="">
            ...
            <h1 className="text-6xl font-fruit tracking-tight mb-4 mt-20">
              {frontmatter.title}
            </h1>
            <p className="text-2xl tracking-wide text-neutral-600">
          ...
          <div className="flex justify-betwee items-center tracking-wide text-neutral-500">
            <div className="flex w-full align-middle space-x-4 not-prose my-4">
              ...
              <p className="">
                Last edited{' '}
                {dayjs(frontmatter.lastEdited).format('MMMM D, YYYY')}
              </p>
              <p>{frontmatter.readingTime}</p>
            </div>
            <div className="flex-col flex flex-shrink h-fill justify-items-end">
              <div className="flex-row">
                <span className="material-icons text-right h-auto text-xl border-2 px-2 text-neutral-400 border-neutral-200 border-solid hover:border-solid  hover:text-neutral-400 hover:border-2 hover:border-neutral-400 rounded-md transition-all ">
                  ios_share
                </span>
              </div>
            </div>
